...
<body>
<div class="wrap cf">
  <h1 class="projTitle">DAPPER</h1>
  <div class="heading cf">
    <h1>My Product Request</h1>
...
{
$b=$row['bid'];
$sql="select * from products where id='$b'";
$result1 = $conn->query($sql);
$i=1;
...
echo '</ul>
  ...
  <div class="subtotal cf">
     <ul>
      <li class="totalRow final"><span class="label">Total number of products issued</span><span class="value">'.$tot.'</span></li>
