...
<img class="mySlides" src="1.1.jpg" style="width:100%">
  ...
  <img class="mySlides" src="1.3.jpg" style="width:100%">
    ...
    <form action="sellbook.php" method="post" align="center">
      ...
      <span>
        <label align="left">Product Name:<br><br></label>
        <input type="text" name="bname" required maxlength="30"/><br><br>
      </span>

       <span>
        <label align="left">Company Name:<br><br></label>
        <input type="text" name="cname" required maxlength="30"/><br><br>
      </span>
...
$sql="INSERT INTO prod(id,title,company,price) VALUES('$bid','$bname','$cname','$mrp')";

if($conn->query($sql)==TRUE)
{
  echo "<div id='wrapper'><div id='inner'><div id='eader'><div id='divbutton' style='align:center';>The selling Price of the Product is:<br>".$sp." Rs</div></div></div></div>";
