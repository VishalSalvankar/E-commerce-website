  ...
  <div align="left">
    ...
    <form  method="post">
     ...
     <!-- <span>
      ...
      <span>
        <label align="left">Product Name:<br></label>
        <input type="text" name="bname" required maxlength="30"/><br>
      </span>

       <span>
        <label align="left">Company Name:<br></label>
        <input type="text" name="cname" required maxlength="30"/><br>
      </span>
...
$sql="INSERT INTO products(id,title,company,stock,price) VALUES('$bid','$bname','$cname','$s','$pr')";

if($conn->query($sql)==TRUE)
{

  echo "<div id='divbutton' style='color:white;'>Product ".$bname." added successfully.</div>";
  header('location: Admin.php');
}
else{
  echo "Product not inserted, Sorry";
}
